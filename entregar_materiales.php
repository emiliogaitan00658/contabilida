    ...
    <div class="container z-depth-1 rounded white" style="width: 95%!important;">
        <table class="table table-bordered" style="padding: 1em;">
            ...
            <tr style="border-bottom: 1px solid black">
                ...
                <th class="vertical-header" scope="col"><span>Entregar</span></th>
                <th class="vertical-header" scope="col"><span>Bodega</span></th>
            </tr>
            </thead>
            <tbody>
            <?php
                ...
                if (($FE >= $contractDateBegin) && ($FE <= $contractDateEnd)) {
                    ...
                    <tr>
                        ...
                        <td><?php
                            ...
                            ?></td>
                        <td>
                            <a href="entregar_materiales.php?indfactura=<?php echo $resultado['indfactura'] . '&textfecha1=' . $fecha1 . '&textfecha2=' . $fecha2 . '&textsucursal=' . $sucursal . '&bandera=' . 1 ?>"
                               class="btn btn-dark"><i
                                        class="icon-checkmark2"></i></a></td>
                        <td>
                            <a href="entregar_materiales.php?indfactura=<?php echo $resultado['indfactura'] . '&textfecha1=' . $fecha1 . '&textfecha2=' . $fecha2 . '&textsucursal=' . $sucursal . '&bandera=' . 2 ?>"
